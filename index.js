...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-joli/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:' + fullname + ' --external bitcore-lib-joli -o ' + fullname + '.js';
    } else {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:bitcore-lib-joli -o bitcore-lib-joli.js';
    }
